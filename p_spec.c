...
void P_SpawnSpecials (void)
{
    ...
    i = M_CheckParm("-frags");
    if ((i && deathmatch) || (dmFrags > 0))
       {
        if (dmFrags > 0)
           {
            levelFragCount = dmFrags;
           }
        else
           {
            levelFragCount = atoi(myargv[i+1]);
           }
	    levelFrags = true;
       }
